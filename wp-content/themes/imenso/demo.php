...
<div id="imenso_owl_slider" class="owl-carousel">
	<?php for($i=1 ; $i<=3 ; $i++){ ?>
	<div class="item">
		...
		<div class="owl_slider_con">
			<span class="owl_text_a">
				<span>
					<span><?php _e('imenso Theme IS The Best', 'imenso'); ?></span>
				<a href="#"><span><i class="fa fa-angle-right"></i></span></a>
				</span>
			</span>
			<span class="owl_text_b"><span><?php _e('Fully Responsive Design', 'imenso'); ?></span></span>
			<span class="owl_text_c"><span><?php _e('Lorem Ipsum is simply dummy text of the printing and industry', 'imenso'); ?></span></span>
			<span class="owl_text_d">
				<a href="#" target="_self" class="btn_a">
					<span><i class="in_left fa fa-shopping-cart"></i><span><?php _e('Purchase Now', 'imenso'); ?></span><i class="in_right fa fa-shopping-cart"></i></span>
				</a>
			</span>
		</div>
	</div>
...
<section class="content_section bg_gray">
	<div class="container icons_spacer">
		<div class="main_title centered upper">
			<h2><span class="line"><span class="dot"></span></span><?php _e('About imenso', 'imenso'); ?></h2>
		</div>
			...
			<div class="col-md-3">
				<div class="service_box">
					...
					<div class="service_box_con centered">
						...
						<span class="desc"><?php _e('There are many variations of demo text passed sages of Lorem Ipsum available the majority.', 'imenso'); ?></span>
						<a href="#" class="ser-box-link"><span></span><?php _e('Read More', 'imenso'); ?></a>
					</div>
				</div>
			</div>
			<?php $j++; } ?>
...
<section class="content_section bg_white">
	<div class="row_spacer clearfix">
		...
		<div class="content">
			<div class="main_title centered upper">
				<h2><span class="line"><i class="fa fa-folder-open"></i></span><?php _e('Our Portfolio', 'imenso'); ?></h2>
			</div>
		</div>
					...
					<div class="filter_item_block video">
						<div class="porto_block">
							<div class="porto_type">
								...
								<div class="porto_nav">
									<a href="#" class="expand_img"><?php _e('View Larger', 'imenso'); ?></a>
									<a href="#" class="detail_link"><?php _e('More Details', 'imenso'); ?></a>
								</div>
							</div>
							<div class="porto_desc">
								<h6 class="name"><?php _e('Flat Logo Design', 'imenso'); ?></h6>
								<div class="porto_meta clearfix">
								<span class="porto_date"><span class="number"><?php _e('20141213', 'imenso'); ?></span><?php _e('December 13, 2014', 'imenso'); ?></span>
								</div>
							</div>
						</div>
					</div><!-- Item -->
...
<section class="content_section bg_gray border_b_n">
	<div class="content row_spacer no_padding">	
		<div class="main_title centered upper">
			<h2><span class="line"><i class="fa fa-pencil-square-o"></i></span><?php _e('From The Blog', 'imenso'); ?></h2>
		</div>
						...
						<li class="filter_item_block animated" data-animation-delay="300" data-animation="rotateInUpLeft">
							<div class="blog_grid_block">
								...
								<div class="blog_grid_con">
									...
									<span class="meta">
										<span class="meta_part"><a href="#"><?php _e('2015/4/30', 'imenso'); ?></a></span>
										<span class="meta_slash">/</span>
										<span class="meta_part"><a href="#"><?php _e('34 Comments', 'imenso'); ?></a></span>
										<span class="meta_slash">/</span>
										<span class="meta_part"><a href="#"><?php _e('News', 'imenso'); ?></a></span>
									</span>
									<p class="desc"><?php _e('Lorem Ipsum is simply dummy text of the prine
		and typesetting industry Lorem Ipsum.', 'imenso'); ?></p>
								</div>
							</div>
						</li>
						<?php $j++; } ?>
				...
				<div class="centered post-btn1">
                    <a class="btn_c append-button">
                        ...
                        <span class="btn_c_t"><?php _e('See More Posts', 'imenso'); ?></span>
...
<!-- Intro Banner -->
	<div class="welcome_banner full_colored">
	    <div class="content clearfix">
		    <h3><?php _e('Best HTML5 Theme Ever!','imenso'); ?></h3>
		<a href="#" target="_self" class="btn_a f_right">
		    <span><i class="in_left  fa fa-shopping-cart"></i><span><?php _e('Purchase Now','imenso');?> </span><i class="in_right fa fa-shopping-cart"></i></span>
		</a>
		<span class="intro_text"><?php _e('There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour of this randomised words which don`t look even slightly believable If you are going to use a passage of Lorem Ipsum.','imenso'); ?></span>
	    </div>
	</div>    
	<!-- End Intro Banner -->
<?php	
