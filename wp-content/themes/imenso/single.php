...
<?php get_template_part('breadcrumbs'); ?>
    ...
    $post_layout = $imenso_theme_options['post_layout'];
    $imageSize = $post_layout == "fullwidth" ? 'imenso_single_post_full' : 'imenso_single_post_image';
    if ($post_layout == "postleft") {
        ...
        $float = "f_left";
        $imageSize = 'imenso_single_post_image';
    } else {
        $float = "f_left";
    }
        ...
        <div id="<?php echo get_the_id(); ?>" <?php post_class('clearfix'); ?> >
							...
							<span class="meta">
								...
								<span class="meta_part">
									<a href="#">
                                        ...
                                        <?php esc_url(comments_popup_link(__('No Comments', 'imenso'), __('1 Comment', 'imenso'), __('% Comments', 'imenso'))); ?> <?php esc_url(edit_post_link(__('Edit', 'imenso'), ' &#124; ', '')); ?>
                                    </a>
								</span>
            ...
            <div class="post_next_prev_con clearfix">
                ...
                <div class="post_next_prev clearfix">
                    <?php next_post_link('%link', '<i class="fa fa-long-arrow-left"></i><span class="t">' . __('Previous Post', 'imenso') . '</span>'); ?>
                    <?php previous_post_link('%link', '<span class="t">' . __('Next', 'imenso') . '</span><i class="fa fa-long-arrow-right"></i>'); ?>
                </div>
            ...
            <?php if (get_the_tag_list() != '') { ?>
                <div class="small_title">
							<span class="small_title_con">
								...
								<span class="s_text"><?php _e('Tags', 'imenso'); ?></span>
							</span>
                </div>
                <div class="tags_con">
            ...
            <div class="about_auther">
                <div class="small_title">
								<span class="small_title_con">
									...
									<span
                                        class="s_text"><?php echo esc_attr($imenso_theme_options['about_author_text']); ?></span>
								</span>
                </div>
        ...
        if ($query->have_posts()) {
            ...
            <div class="small_title">
							<span class="small_title_con">
								...
								<span
                                    class="s_text"><?php echo esc_attr($imenso_theme_options['related_post_text']); ?></span>
							</span>
            </div>
                ...
                while ($query->have_posts()) {
                    ...
                    <div class="related_img_con">
                        <a href="<?php the_permalink(); ?>" class="related_img">
                            <?php the_post_thumbnail('imenso_related_post_thumb', $img_class); ?>
