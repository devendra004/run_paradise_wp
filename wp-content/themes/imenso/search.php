...
<?php $imenso_theme_options = imenso_theme_options(); ?>
    <section class="content_section page_title">
        <div class="content clearfix">
            <h1 class="">
                <?php printf(__('Search Results For: "%s"', 'imenso'), '<span>' . esc_attr(get_search_query()) . '</span>'); ?>
            </h1>
                ...
                <div class="content_block col-md-9 <?php echo esc_attr($float); ?> ">
                    ...
                    <?php } else { ?>
                        <div class="search_error">
                            <div class="search_err_heading"><h2><?php _e("Nothing Found", 'imenso'); ?></h2></div>
                            <div class="wave_searching">
                                <p><?php _e("Sorry, but nothing matched your search criteria. Please try again with some different keywords.", 'imenso'); ?></p>
                            </div>
                        </div>
                        <?php get_search_form(); ?>
                    <?php } ?>
