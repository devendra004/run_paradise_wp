<?php get_header(); ?>
    <section class="content_section page_title">
        <div class="content clearfix">
            <h1 class="">
                <?php printf(__('Category Archives: %s', 'imenso'), ucfirst(single_cat_title('', false))); ?>
            </h1>
        ...
        <div class="content row_spacer">
            <div class="main_title centered upper">
                <h2><span class="line"><i
                            class="fa fa-pencil"></i></span><?php printf(__('Category: %s', 'imenso'), ucfirst(single_cat_title('', false))); ?>
                </h2>
            </div>
            <?php
