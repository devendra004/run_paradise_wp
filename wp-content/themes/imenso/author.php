<?php get_header(); ?>
    <section class="content_section page_title">
        <div class="content clearfix">
            <h1 class="">
                <?php printf(__('Author Archives: %s', 'imenso'), '<span class="vcard"><a class="url fn n" href="' . esc_url(get_author_posts_url(get_the_author_meta("ID"))) . '" title="' . esc_attr(get_the_author()) . '" rel="me">' . get_the_author() . '</a></span>'); ?>
            </h1>
        ...
        <div class="content row_spacer">
            <div class="main_title centered upper">
                <h2><span class="line"><i
                            class="fa fa-pencil"></i></span><?php printf(__('Posts By %s ', 'imenso'), get_the_author()); ?>
                </h2>
            </div>
            <?php
            $blog_layout = $imenso_theme_options['blog_layout'];
            $imageSize = $blog_layout == "fullwidth" ? 'imenso_home_post_full_thumb' : 'imenso_home_post_thumb';
